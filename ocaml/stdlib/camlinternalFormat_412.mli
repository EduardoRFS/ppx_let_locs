...
open CamlinternalFormatBasics_412
...
type ('b, 'c, 'e, 'f) fmt_ebb = Fmt_EBB :
     ('a, 'b, 'c, 'd, 'e, 'f) CamlinternalFormatBasics_412.fmt ->
     ('b, 'c, 'e, 'f) fmt_ebb

val make_printf :
  (('b, 'c) acc -> 'd) -> ('b, 'c) acc ->
  ('a, 'b, 'c, 'c, 'c, 'd) CamlinternalFormatBasics_412.fmt -> 'a
...
val type_format :
  ('x, 'b, 'c, 't, 'u, 'v) CamlinternalFormatBasics_412.fmt ->
  ('a, 'b, 'c, 'd, 'e, 'f) CamlinternalFormatBasics_412.fmtty ->
  ('a, 'b, 'c, 'd, 'e, 'f) CamlinternalFormatBasics_412.fmt
...
val format_of_string_fmtty :
  string ->
  ('a, 'b, 'c, 'd, 'e, 'f) CamlinternalFormatBasics_412.fmtty ->
  ('a, 'b, 'c, 'd, 'e, 'f) CamlinternalFormatBasics_412.format6
...
val char_of_iconv : CamlinternalFormatBasics_412.int_conv -> char
val string_of_formatting_lit : CamlinternalFormatBasics_412.formatting_lit -> string

val string_of_fmtty :
  ('a, 'b, 'c, 'd, 'e, 'f) CamlinternalFormatBasics_412.fmtty -> string
val string_of_fmt :
